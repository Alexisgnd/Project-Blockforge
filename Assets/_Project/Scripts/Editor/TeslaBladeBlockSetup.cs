...
// =========================================================
// AJOUT DES 3 LAMES DE TESLA A MODELE 3D (Slicer -> Nova)
// A L'INVENTAIRE
// Menu : Blockforge > Setup Tesla Blade Blocks
// - Resynchronise les assets BlockDefinition sur la liste
//   canonique (les 3 Block_Tesla_N* recoivent leur FBX
...
[InitializeOnLoad]
public static class TeslaBladeBlockSetup
{
    private const string ScenePath = "Assets/_Project/Scenes/Garage.unity";
    private const string AutoRunMarker = "Library/BlockforgeTeslaBladeBlocks.done";
    private const string MaterialsMarker = "Library/BlockforgeTeslaBladeMaterials.done";

    static TeslaBladeBlockSetup()
    {
    ...
    [MenuItem("Blockforge/Setup Tesla Blade Blocks")]
    ...
    private static bool Run()
    {
        ...
        if (controller != null)
        {
            ...
            Debug.Log($"[TeslaBladeBlockSetup] {blocks.Length} blocs relies a l'inventaire de la scene " +
        ...
        if (controller == null)
        {
            Debug.LogError("[TeslaBladeBlockSetup] GarageInventoryController introuvable dans la scene " +
        ...
        Debug.Log($"[TeslaBladeBlockSetup] {blocks.Length} blocs relies a l'inventaire ; scene Garage sauvegardee.");
        return true;
    }
}
