...
// =========================================================
// AJOUT DES 4 CANONS ELECTRIQUES A MODELE 3D (Piercer -> Erazer)
// A L'INVENTAIRE
// Menu : Blockforge > Setup Rail Cannon Blocks
// - Resynchronise les assets BlockDefinition sur la liste
//   canonique (les 4 Block_Rail_N* recoivent leur FBX
...
[InitializeOnLoad]
public static class RailCannonBlockSetup
{
    private const string ScenePath = "Assets/_Project/Scenes/Garage.unity";
    private const string AutoRunMarker = "Library/BlockforgeRailCannonBlocks.done";
    private const string MaterialsMarker = "Library/BlockforgeRailCannonMaterials.done";

    static RailCannonBlockSetup()
    {
    ...
    [MenuItem("Blockforge/Setup Rail Cannon Blocks")]
    ...
    private static bool Run()
    {
        ...
        if (controller != null)
        {
            ...
            Debug.Log($"[RailCannonBlockSetup] {blocks.Length} blocs relies a l'inventaire de la scene " +
        ...
        if (controller == null)
        {
            Debug.LogError("[RailCannonBlockSetup] GarageInventoryController introuvable dans la scene " +
        ...
        Debug.Log($"[RailCannonBlockSetup] {blocks.Length} blocs relies a l'inventaire ; scene Garage sauvegardee.");
        return true;
    }
}
